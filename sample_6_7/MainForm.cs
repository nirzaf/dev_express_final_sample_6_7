...
namespace sample_6_7 {
  public partial class MainForm : DevExpress.XtraBars.Ribbon.RibbonForm {
    ...
    public void ShowPrintPreview(string caption, XtraReport xtraReport) {
      ShowPrintPreview(caption, pp => pp.ShowDocument(xtraReport));
    }

    private void roomBookingReportItem_ItemClick(object sender, ItemClickEventArgs e) {
      ShowPrintPreview("Room Booking Report", new RoomBookingReport());
    }
  }
}
